...
public class ClienteController {
	...
	/**
	 * Para manejar archivos de log desde el parametro de, se debe enviar como
	 * parametro el atributo de tipo Locale
	 * 
	 */
	...
	public String listar(@RequestParam(name = "page", defaultValue = "0") int page, Model model,
		...
		// El metodo el atributo Locale permite obtener los valores de las llaves
		// puestas en el archivo properties.
